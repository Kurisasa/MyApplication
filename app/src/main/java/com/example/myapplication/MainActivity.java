...
public class MainActivity extends AppCompatActivity
    ...
    private TextView txtName, textView;
    ...
    private static final String TAG_NEW_TRANSACTION = "new_transaction";
    private static final String TAG_ALL_TRANSACTION = "all_transactions";
    ...
    private void loadNavHeader() {
        ...
        textView.setText("www.androidhive.info");
       ...
       // nav_view.getItem(3).setActionView(R.layout.menu_dot);
    }
    ...
    private void changeLanguageOperation(){
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.new_transaction:
                        navItemIndex = 1;
                        CURRENT_TAG = TAG_NEW_TRANSACTION;
                        break;
